...
namespace Hangman_Lite__Part_8_Project_
{
    ...
    public partial class Form1 : Form
    {
        ...
        public List<string> wordList = new List<string>() {"COMPUTER", "BASEBALL", "MAGNETIC", "POWERFUL", "BUILDING", "LOCATION", "TERMINAL", "WEAKNESS", "ROMANTIC", "CLOTHING" };
        ...
        public void ResetGame()
        {
            ...
            lblWord.Text = word;
            guessCounter.Text = "Guesses Left: 5";
            btnReplay.Visible = false;
            pnlMan1.Visible = true;
            pnlMan2.Visible = true;
            pnlMan3.Visible = true;
            pnlMan4.Visible = true;
            pnlMan5.Visible = true;
            panelOrder = 0;
            btnA.Visible = true;
            btnB.Visible = true;
            btnC.Visible = true;
        ...
        public void ReplaceLetter(string letter)
        {
            ...
            else if (!secretWord.Contains(letter))
            {
                ...
                if (panelOrder == 1)
                {
                    ...
                    guessCounter.Text = "Guesses Left: 4";
                }
                ...
                else if (panelOrder == 4)
                {
                    pnlMan4.Visible = false;
